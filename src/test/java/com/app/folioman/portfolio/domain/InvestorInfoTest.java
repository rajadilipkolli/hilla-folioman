...
class InvestorInfoTest {
    ...
    void getUserCasDetails() {
        assertThat(investorInfo.getUserCasDetailsEntity()).isNull();
    }

    @Test
    void setUserCasDetails() {
        InvestorInfo result = investorInfo.setUserCasDetailsEntity(userCasDetailsEntity);
        assertThat(investorInfo.getUserCasDetailsEntity()).isEqualTo(userCasDetailsEntity);
        assertThat(result).isSameAs(investorInfo);
    }

    @Test
    void setUserCasDetailsWithNull() {
        InvestorInfo result = investorInfo.setUserCasDetailsEntity(null);
        assertThat(investorInfo.getUserCasDetailsEntity()).isNull();
        assertThat(result).isSameAs(investorInfo);
    }
    ...
    void fluentInterfaceChaining() {
        InvestorInfo result = investorInfo
                ...
                .setUserCasDetailsEntity(userCasDetailsEntity);
