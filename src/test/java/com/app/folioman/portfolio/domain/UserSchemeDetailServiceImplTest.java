...
class UserSchemeDetailServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        userSchemeDetailsEntity = new UserSchemeDetailsEntity();
        userSchemeDetailsEntity.setId(1L);
        userSchemeDetailsEntity.setRtaCode("ABC123");
        userSchemeDetailsEntity.setScheme("Test Scheme");
        userSchemeDetailsEntity.setIsin("INE123456789");
    ...
    void setUserSchemeAMFIIfNull_WithShortRtaCode_ShouldLogWarning() {
        UserSchemeDetailsEntity shortRtaCodeScheme = new UserSchemeDetailsEntity();
        shortRtaCodeScheme.setId(2L);
        shortRtaCodeScheme.setRtaCode("A");

        when(userSchemeDetailsRepository.findByAmfiIsNull()).thenReturn(List.of(shortRtaCodeScheme));
    ...
    void setUserSchemeAMFIIfNull_WithNullRtaCode_ShouldLogWarning() {
        UserSchemeDetailsEntity nullRtaCodeScheme = new UserSchemeDetailsEntity();
        nullRtaCodeScheme.setId(3L);
        nullRtaCodeScheme.setRtaCode(null);

        when(userSchemeDetailsRepository.findByAmfiIsNull()).thenReturn(List.of(nullRtaCodeScheme));
    ...
    void setUserSchemeAMFIIfNull_WithValidRtaCodeAndMatchingSchemes_ShouldUpdateSchemeDetails() {
        when(userSchemeDetailsRepository.findByAmfiIsNull())
                .thenReturn(Collections.singletonList(userSchemeDetailsEntity));
        when(mfSchemeService.fetchSchemesByRtaCode("ABC12")).thenReturn(Collections.singletonList(mfSchemeProjection));
    ...
    void setUserSchemeAMFIIfNull_WithValidRtaCodeAndNoMatchingIsin_ShouldUseFirstScheme() {
        UserSchemeDetailsEntity differentIsinScheme = new UserSchemeDetailsEntity();
    ...
    void setUserSchemeAMFIIfNull_WithEmptyMfSchemeListAndSchemeWithIsin_ShouldExtractIsin() {
        UserSchemeDetailsEntity schemeWithIsin = new UserSchemeDetailsEntity();
    ...
    void setUserSchemeAMFIIfNull_WithEmptyMfSchemeListAndSchemeWithoutIsin_ShouldFetchSchemes() {
        UserSchemeDetailsEntity schemeWithoutIsin = new UserSchemeDetailsEntity();
        schemeWithoutIsin.setId(6L);
        schemeWithoutIsin.setRtaCode("GHI012");
        schemeWithoutIsin.setScheme("Test Income Scheme");

        when(userSchemeDetailsRepository.findByAmfiIsNull()).thenReturn(List.of(schemeWithoutIsin));
        when(mfSchemeService.fetchSchemesByRtaCode("GHI01")).thenReturn(Collections.emptyList());
        when(mfSchemeService.fetchSchemes("Test Income Scheme"))
                .thenReturn(Collections.singletonList(fundDetailProjection));
    ...
    void setUserSchemeAMFIIfNull_WithEmptyMfSchemeListAndNonMatchingFundDetails_ShouldNotUpdate() {
        UserSchemeDetailsEntity nonMatchingScheme = new UserSchemeDetailsEntity();
    ...
    void setUserSchemeAMFIIfNull_WithEmptyMfSchemeListAndIsinButNotFound_ShouldNotUpdate() {
        UserSchemeDetailsEntity schemeWithIsinNotFound = new UserSchemeDetailsEntity();
    ...
    void setUserSchemeAMFIIfNull_WithEmptyMfSchemeListAndEmptyIsinAfterExtraction_ShouldLogWarning() {
        UserSchemeDetailsEntity schemeWithEmptyIsin = new UserSchemeDetailsEntity();
    ...
    void findBySchemesIn_WithValidList_ShouldReturnResults() {
        List<UserSchemeDetailsEntity> inputList = Collections.singletonList(userSchemeDetailsEntity);
        List<UserSchemeDetailsEntity> expectedResult = Collections.singletonList(userSchemeDetailsEntity);

        when(userSchemeDetailsRepository.findByUserFolioDetails_SchemesIn(inputList))
                .thenReturn(expectedResult);

        List<UserSchemeDetailsEntity> result = userSchemeDetailService.findBySchemesIn(inputList);
    ...
    void findBySchemesIn_WithEmptyList_ShouldReturnEmptyList() {
        List<UserSchemeDetailsEntity> inputList = Collections.emptyList();
        List<UserSchemeDetailsEntity> expectedResult = Collections.emptyList();
