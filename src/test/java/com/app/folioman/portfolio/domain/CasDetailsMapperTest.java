...
class CasDetailsMapperTest {
    ...
    void convert() {
        ...
        UserCasDetailsEntity result = mapper.convert(local, newFolios, newSchemes, newTransactions);
    ...
    void mapUserFolioDTOToUserFolioDetails() {
        ...
        UserFolioDetailsEntity result =
                mapper.mapUserFolioDTOToUserFolioDetails(localFolio, newSchemes, newTransactions);
    ...
    void schemeDTOToSchemeEntity() {
        ...
        UserSchemeDTO localScheme = new UserSchemeDTO(
                ...
                null,
                new ArrayList<>());
        UserSchemeDetailsEntity result = mapper.schemeDTOToSchemeEntity(localScheme, newTransactions);
