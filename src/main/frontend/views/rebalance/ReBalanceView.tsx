            ...
            <Card theme="outlined">
                ...
                <Details summary="About Rebalancing" opened={false}>
                    <div className="p-s text-secondary">
                        ...
                        <p>Enter your current fund values, desired ratios, and additional investment amount to calculate the optimal way to invest.</p>
                    </div>
                </Details>
                            ...
                            <div className="mt-m">
                                <Details summary="Rebalancing Details" opened={false}>
                                    <div className="p-s">
                                        ...
                                        <p>Total Portfolio Value After Rebalance: 
