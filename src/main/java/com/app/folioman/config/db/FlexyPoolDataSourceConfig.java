...
public class FlexyPoolDataSourceConfig {
    ...
    private static final int maxOverflowPoolSize = 5;
    private static final int connectionAcquisitionThresholdMillis = 50;
                    ...
                    FlexyPoolConfiguration<HikariDataSource> flexyPoolConfiguration =
                            new FlexyPoolConfiguration.Builder<>(
                                    ...
                                    .setEventListenerResolver(
                                            () -> List.of(new ConnectionAcquisitionTimeoutEventListener()))
                                    .build();
