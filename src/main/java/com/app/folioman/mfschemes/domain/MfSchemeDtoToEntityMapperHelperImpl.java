...
class MfSchemeDtoToEntityMapperHelperImpl implements MfSchemeDtoToEntityMapperHelper {
    ...
    private final ConcurrentHashMap<String, MFSchemeTypeEntity> schemeTypeCache = new ConcurrentHashMap<>();
    ...
    private MfAmcEntity findOrCreateAmcEntity(String amc) {
    ...
    @Override
    public MFSchemeTypeEntity findOrCreateMFSchemeTypeEntity(
        ...
        return schemeTypeCache.computeIfAbsent(schemeTypeKey, key -> {
            ...
            MFSchemeTypeEntity existingType =
            ...
            MFSchemeTypeEntity newSchemeType = new MFSchemeTypeEntity();
